...
if (isset($_POST['reg_user'])) 
{
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO users (username, email, birthday,position,hobbies,current,finish, password) 
  			  VALUES('$username', '$email','$birthday','$position', '$hobbies', '$current', '$finish',  '$password')";
