	...
	<div class="container">
		...
		<div id="wrapper">
			<form id="signin" method="post" action="login.php" autocomplete="off">
				...
				<input type="text" class="signin__input" id="name"  name="user" placeholder="Имя пользователя" />
				<input type="password" class="signin__input" id="pass" name="pass" placeholder="Пароль" />
